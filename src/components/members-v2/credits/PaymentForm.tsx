  ...
  const handlePaymentConfirmation = async (
    ...
    try {
      ...
      const stripeReturnUrl = returnUrl
        ? `${baseUrl}/members-v2/${userId}/credits/success?returnUrl=${returnUrl}`
        : `${baseUrl}/members-v2/${userId}/credits/success`;
      ...
      if (paymentError) {
        setError(
          paymentError.message ||
            'Something went wrong confirming your payment on Stripe'
        );
        setIsLoading(false);
        return;
      }
